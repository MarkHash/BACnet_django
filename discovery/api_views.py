"""
BACnet API Views Module

This module contains all class-based API views that provide JSON endpoints for the
BACnet monitoring system. Separated from HTML rendering views for better code
organization following enterprise development practices.

API Views:
- DeviceStatusAPIView: Real-time device status and connectivity monitoring
- DeviceTrendsAPIView: Historical data trends and analytics for device points
- DevicePerformanceAPIView: Performance metrics and statistics dashboard
- DataQualityAPIView: Data completeness, accuracy, and quality analysis
- AnomalyListAPIView: System-wide anomaly detection and filtering
- DeviceAnomalyAPIView: Device-specific anomaly analysis
- AnomalyStatsAPIView: Comprehensive anomaly statistics and reporting

Helper Functions:
- calculate_completeness_score: Data completeness analysis
- calculate_accuracy_score: Outlier detection using IQR method
- calculate_freshness_score: Data recency scoring
- calculate_consistency_score: Reading interval consistency analysis
